...
<body>
    <?php
        ...
        if(getNombreDept($id,$pdo)!=='Contabilidad') {
            ...
            aviso('No se pueden borrar los empleados del departamento contabilidad', 'danger');
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 offset-3">
                <h4>Estas seguro de eliminar el empleado</h4>
                
                <form action="" method="post"> 
                        <input type="hidden" name="id" value="<?= $id ?>">
                        <?= token_csrf() ?>
                        <button type="submit" class="btn btn-sm btn-danger">Borrar</button>
                        <a href="/index.php" class="btn btn-sm btn-success">Cancelar</a>
                </form>
